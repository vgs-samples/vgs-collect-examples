...
var highlightErrors = function (targetForm, errors) {
  $(targetForm)
    .find(".vgs-collect-container__invalid")
...
const css = {
  "@font-face": {
    ...
    "font-display": "swap",
    src:
      'url(https://fonts.gstatic.com/s/inter/v3/UcCO3FwrK3iLTeHuS_fvQtMwCp50KnMw2boKoduKmMEVuLyfAZthjp-Ek-_EeAmM.woff) format("woff")',
